...
def main():
    ...
    # Preserve the left-to-right tip order of the rooted, pruned user tree.
    # Pensieve never alphabetically reorders biological sequences for MSA output.
    common = [tip.name for tip in tree.get_terminals()]
